      ...
      {loading ? (
        ...
        <main>
          ...
          >
            ...
            <h1>About</h1>
            <p className="w-2/3">
              Cyber-physical security is vital in our interconnected world,
              where digital systems merge with physical infrastructure. As
              technology becomes more ingrained in daily life, vulnerabilities
              in these systems emerge. A comprehensive strategy is needed,
              combining cyber security measures with physical security
              protocols. Strong defenses against cyber threats and resilient
              physical components are essential for infrastructure protection
              and data security. The rise of technologies like the Internet of
              Things (IoT) and smart devices intensifies the importance of
              cyber-physical security. While offering convenience, they also
              broaden the attack surface for malicious actors. Protecting
              critical infrastructure, from power grids to healthcare
              facilities, demands continuous vigilance and adaptive security
              measures. Establishing global standards, conducting regular risk
              assessments, and fostering cybersecurity awareness are pivotal.
              Integrating artificial intelligence and machine learning enhances
              threat detection and response capabilities in real time.
              Understanding that data breaches transcend the digital realm is
              crucial. Their potential impact on public safety, economic
          ...
          >
            ...
            <div className="speakers-cards ">
              ...
              <div class="card">
                ...
                <div class="heading">
                  {" "}
                  Associate Professor, Indian Institute of Information
                  Technology Kottayam.
                </div>
              </div>
